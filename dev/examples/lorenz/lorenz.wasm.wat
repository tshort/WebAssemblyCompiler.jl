(module
 ...
 (global $g18446744071115946416 (ref null $2) (struct.new_default $2))
 (global $g7960757319594425723 stringref (string.const "ODE"))
 (global $g15380571356664310471 (ref null $23) (struct.new $23
  (struct.new $17
   (struct.new $5
    (array.new_fixed $4 1
     (struct.new $1
 ...
 (func $update (type $49)
  ...
  (block $block$4$break
   (block
    (local.set $37
     (global.get $g18446744071115946416)
    )
    (local.set $38
     (global.get $g15380571356664310471)
    )
    (local.set $39
     (struct.get $23 0
      (local.get $38)
